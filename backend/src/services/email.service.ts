...
HireMind Automated System`;
  ...
  async sendCandidateOffer(email: string, name: string, jobTitle: string, offerUrl: string) {
...
HireMind Recruitment Team`;
  ...
  async sendCandidateHired(email: string, name: string, jobTitle: string) {
...
HireMind IT Support`;
  ...
  async sendLeaveApproval(email: string, name: string, leaveType: string, startDate: Date, endDate: Date) {
...
HireMind Automated System`;
  ...
  async sendLeaveRejection(email: string, name: string, leaveType: string, startDate: Date, endDate: Date, reason: string) {
...
HireMind Automated System`;
  ...
  async sendTaskAssignment(email: string, name: string, taskTitle: string, dueDate: Date) {
...
HireMind Automated System`;
  ...
  async sendCandidateInterviewReady(hrEmail: string, candidateName: string, jobTitle: string, analysisUrl: string) {
...
HireMind Auto-Recruit Daemon`;
  ...
  async sendCandidateHiredAlert(hrEmail: string, candidateName: string, jobTitle: string) {
...
HireMind Auto-Recruit Daemon`;
  ...
  async sendLeaveApprovalRequest(managerEmail: string, managerName: string, employeeName: string, leaveType: string, startDate: Date, endDate: Date) {
...
HireMind Automated System`;
  ...
  async sendTaskCompletionAlert(managerEmail: string, managerName: string, employeeName: string, taskTitle: string) {
...
HireMind Automated System`;
  ...
  async sendInterviewReminder(interviewerEmail: string, interviewerName: string, candidateName: string, scheduledAt: Date, meetingUrl: string) {
