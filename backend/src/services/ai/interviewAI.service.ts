 ...
 */
export async function analyzeInterviewPerformance(interviewId: string, transcriptText: string) {
  try {
    const prompt = `
 ...
 */
export async function transcribeInterviewAudio(audioBuffer: Buffer, filename: string = 'interview.webm'): Promise<string> {
