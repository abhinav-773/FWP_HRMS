...
import { WorkflowRule, WorkflowAction } from '@prisma/client';
...
export class WorkflowService {
   ...
   */
  async executeEvent(event: string, context: { userId: string; employeeProfileId?: string }) {
    await this.seedDefaultRules();
  ...
  private async runAction(action: WorkflowAction, context: { userId: string; employeeProfileId?: string }) {
