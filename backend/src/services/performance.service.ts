...
export class PerformanceService {
  // Goals (OKRs)
  async createGoal(employeeId: string, title: string, description?: string, targetDate?: string) {
  ...
  async updateGoalProgress(goalId: string, progress: number, status?: GoalStatus) {
  ...
  // Reviews
  async createReview(employeeId: string, reviewerId: string, reviewPeriod: string, rating: number, comments: string) {
  ...
  // Peer Feedback
  async requestFeedback(employeeId: string, peerId: string, reviewPeriod: string, feedbackText: string, rating?: number) {
  ...
  async generateAISummary(employeeId: string, reviewPeriod: string) {
    try {
