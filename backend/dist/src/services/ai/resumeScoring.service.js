...
function computeKeywordScore(resumeText, jobText) {
 ...
 */
export async function scoreResume(candidateId, resumeText, jobText, candidateSkills = []) {
...
//# sourceMappingURL=resumeScoring.service.js.map