...
router.post('/', requireAnyRole([Role.SUPER_ADMIN, Role.HR_RECRUITER]), createEmployee);
// Only Admins, HR, or Managers can update employees
router.put('/:id', requireAnyRole([Role.SUPER_ADMIN, Role.HR_RECRUITER, Role.SENIOR_MANAGER]), updateEmployee);
